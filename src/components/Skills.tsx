...
const techs: Tech[] = [
  ...
  { name: 'JavaScript',   Icon: SiJavascript,  color: '#D4A600', floatDuration: 3.5, floatDelay: 0.6,  floatY: 12 },
  ...
  { name: 'Tailwind CSS', Icon: SiTailwindcss, color: '#0694B4', floatDuration: 3.0, floatDelay: 0.4,  floatY: 11 },
  { name: 'Next.js',      Icon: SiNextdotjs,   color: '#1c1917', floatDuration: 3.3, floatDelay: 0.7,  floatY: 8  },
  { name: 'Node.js',      Icon: SiNodedotjs,   color: '#339933', floatDuration: 2.9, floatDelay: 1.0,  floatY: 10 },
  { name: 'Express',      Icon: SiExpress,     color: '#1c1917', floatDuration: 3.6, floatDelay: 0.2,  floatY: 9  },
  { name: 'Kafka',        Icon: SiApachekafka, color: '#1c1917', floatDuration: 2.7, floatDelay: 0.5,  floatY: 12 },
  ...
  { name: 'Firebase',     Icon: SiFirebase,    color: '#F5A623', floatDuration: 3.1, floatDelay: 0.6,  floatY: 11 },
  ...
  { name: 'Scikit-learn', Icon: SiScikitlearn, color: '#E07B39', floatDuration: 3.8, floatDelay: 0.4,  floatY: 8  },
  { name: 'React Native', Icon: SiReact,       color: '#61DAFB', floatDuration: 3.2, floatDelay: 1.0,  floatY: 9  },
  { name: 'Expo',         Icon: SiExpo,        color: '#1c1917', floatDuration: 2.9, floatDelay: 0.2,  floatY: 11 },
  ...
  { name: 'GitHub',       Icon: SiGithub,      color: '#1c1917', floatDuration: 3.6, floatDelay: 0.5,  floatY: 8  },
  { name: 'Vercel',       Icon: SiVercel,      color: '#1c1917', floatDuration: 3.1, floatDelay: 0.1,  floatY: 12 },
  { name: 'Docker',       Icon: SiDocker,      color: '#2496ED', floatDuration: 2.8, floatDelay: 0.6,  floatY: 9  },
  { name: 'Linux',        Icon: SiLinux,       color: '#B8860B', floatDuration: 3.4, floatDelay: 1.1,  floatY: 7  },
  ...
  return (
    <section id="skills" className="py-24 px-6">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          <p className="font-mono text-amber-600 text-xs tracking-[0.3em] uppercase mb-3">03. Skills</p>
          <h2 className="text-3xl md:text-4xl font-bold text-stone-900">Tech Stack</h2>
          <p className="text-stone-500 text-sm mt-3 font-mono">hover to explore</p>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {techs.map((tech, i) => (
            ...
            >
              {/* Icon card */}
              <div
                className="w-16 h-16 flex items-center justify-center rounded-2xl bg-white border border-stone-200 transition-all duration-300"
                style={{ boxShadow: '0 2px 8px rgba(120,113,108,0.10)' }}
                onMouseEnter={e => {
                  const el = e.currentTarget as HTMLElement
                  el.style.boxShadow = `0 0 18px ${tech.color}35, 0 4px 16px rgba(120,113,108,0.15)`
                  el.style.borderColor = `${tech.color}55`
                  el.style.backgroundColor = `${tech.color}0e`
                }}
                onMouseLeave={e => {
                  const el = e.currentTarget as HTMLElement
                  el.style.boxShadow = '0 2px 8px rgba(120,113,108,0.10)'
              ...
              {/* Name */}
              <span className="text-xs font-mono text-stone-400 group-hover:text-stone-700 transition-colors duration-200 whitespace-nowrap">
                {tech.name}
              </span>
            </motion.div>
          ))}
